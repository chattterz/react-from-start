...
const authors = [
  { name: 'Jake', nickname: 'mr whatever works' },
  { name: 'Justin', nickname: 'hillary harry' },
  { name: 'Diana', nickname: 'dinossssaurus' },
  { name: 'Deborah', nickname: 'the red pill' },
  { name: 'Maria', nickname: 'alwz the sun' },
]
